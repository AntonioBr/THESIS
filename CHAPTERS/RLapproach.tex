...
We can explain this algorithm briefly recalling some trigonometry. Let's suppose to be in a simple $1d$-case like the one represented in figure ~\ref{fig:LMComputations}.
